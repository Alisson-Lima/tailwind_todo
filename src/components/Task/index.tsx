        ...
        />
        {
          !isEdit ? (
            ...
            > 
              ...
              <input 
                type="text"
                className="bg-transparent text-xl outline-none text-gray-100 border-b-2 font-lato"
      ...
      <div className="action_buttons flex">
        {
          isEdit && (
            <button 
              className="text-xl text-gray-100 rounded-md w-12 h-9 flex items-center justify-center mr-1 hover:bg-gray-300 transition-colors"
        ...
        <button className="p-2 group" onClick={handleEditTask}>
        ...
        <button className="p-2 pr-0 group" onClick={handleDeleteTask}>
